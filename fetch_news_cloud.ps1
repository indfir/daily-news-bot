...
$topics = @{
    ...
    "Data / AI" = @(
            ...
            "https://datarobot.com/blog/feed",
            "https://www.datacamp.com/blog/rss.xml",
            "https://data-flair.training/blogs/feed",
            "https://neptune.ai/blog/feed",
            # --- Data Engineering & Big Data ---
            "https://datanami.com/feed",
            "https://datafloq.com/feed",
            "https://www.databricks.com/blog/feed",
            "https://precisely.com/feed",
            "https://smartdatacollective.com/feed",
            "https://www.anaconda.com/blog/feed",
            "https://siliconangle.com/category/big-data/feed",
            # --- Business Intelligence & Analytics ---
            "https://biinsight.com/feed",
            "https://dataversity.net/category/data-education/feed/",
            "https://insightsoftware.com/blog/feed",
            "https://revealbi.io/blog/feed",
            "https://tableau.com/feed.rss",
            "https://domo.com/blog/feed",
            "https://teradata.com/rss/blogs",
            "https://splashbi.com/feed",
            "https://feeds.feedburner.com/sqlbi_blog",
            "https://powerbiweekly.info/rss.xml",
            "https://feeds.feedburner.com/analyticsinsight",
            "https://flowingdata.com/feed",
            # --- Research / arXiv ---
...
$topicKeywords = @{
    ...
    "Data / AI" = @(
        ...
        # --- Data Science ---
        "data science", "data scientist", "data analysis", "analisis data",
        "dataset", "annotation", "labeling", "preprocessing",
        "statistics", "statistik", "regression", "clustering",
        "feature engineering", "exploratory", "EDA",
        "Pandas", "NumPy", "Jupyter", "notebook", "Python data",
        "R programming", "SAS", "SPSS",
        # --- Data Engineering ---
        "data engineering", "data engineer", "data pipeline",
        "ETL", "ELT", "data integration", "data ingestion",
        "data lake", "data lakehouse", "data warehouse", "gudang data",
        "data catalog", "data lineage", "data governance", "tata kelola data",
        ...
        "Fivetran", "Airbyte", "data mesh", "data fabric",
        "streaming data", "batch processing", "real-time data",
        # --- Business Intelligence ---
        "business intelligence", "BI", "inteligensi bisnis",
        "dashboard", "reporting", "laporan", "report builder",
        "data visualization", "data visualisation", "visualisasi data",
        "Power BI", "Tableau", "Looker", "Qlik", "Metabase",
        "OLAP", "OLTP", "cube", "pivot", "drill-down",
        "KPI", "metric", "scorecard", "OKR",
        "self-service analytics", "ad hoc", "embedded analytics",
        "decision support", "decision making", "pengambilan keputusan",
        "Domo", "Sisense", "MicroStrategy", "SAP Analytics",
        "data-driven", "business analytics", "analitik bisnis",
        # --- Big Data ---
        "big data", "data besar", "data massive",
        "distributed computing", "cloud data", "data cloud",
        "NoSQL", "MongoDB", "Cassandra", "data store",
        "data platform", "data infrastructure", "infrastruktur data",
        "data strategy", "strategi data", "data maturity",
        "data ops", "DataOps", "observability"
    )
